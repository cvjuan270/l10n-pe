"""Resultado del cruce Odoo vs. propuesta SUNAT para un periodo RCE.

Generado por ``sire.rce.periodo._sire_rce_cross()`` -- calco exacto de
``tgr_sire_rvie/models/sire_rvie_diff_line.py``. Clave de cruce: ``(tipo CP,
serie, numero)``.
"""
...
class SireRceDiffLine(models.Model):
    _name = "sire.rce.diff.line"
    _description = "SIRE RCE - Linea de diferencia (Odoo vs. SUNAT)"
